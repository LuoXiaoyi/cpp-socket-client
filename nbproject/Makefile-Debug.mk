...
${OBJECTDIR}/socket/client.o: socket/client.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/client.o socket/client.cpp

${OBJECTDIR}/socket/epoll_client.o: socket/epoll_client.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/epoll_client.o socket/epoll_client.cpp

${OBJECTDIR}/socket/poll_client.o: socket/poll_client.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/poll_client.o socket/poll_client.cpp

${OBJECTDIR}/socket/select_client.o: socket/select_client.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/select_client.o socket/select_client.cpp
